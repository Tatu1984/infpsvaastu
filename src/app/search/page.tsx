...
function SearchContent() {
  ...
  }, [location, listingType, propertyCategory, propertyType, bedrooms, minPrice, maxPrice, sortBy])
  ...
  // Handle category change - reset property type when category changes
  const handleCategoryChange = (category: string) => {
    setPropertyCategory(category)
    setPropertyType(propertyTypesByCategory[category]?.[0] || "All Types")
  }
