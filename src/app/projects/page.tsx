...
export const metadata = {
  title: "Builder Projects | INFPSVaastu",
  description: "Discover residential and commercial projects from India's top builders. Find your perfect home in a new development.",
}
