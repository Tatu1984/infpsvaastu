...
// Property categories
export const propertyCategories = ['RESIDENTIAL', 'COMMERCIAL'] as const
...
export const residentialPropertyTypes = ['APARTMENT', 'HOUSE', 'VILLA', 'PLOT', 'PG', 'ROOMMATE', 'PENTHOUSE', 'STUDIO', 'INDEPENDENT_FLOOR'] as const
export const commercialPropertyTypes = ['OFFICE_SPACE', 'SHOP', 'SHOWROOM', 'WAREHOUSE', 'INDUSTRIAL', 'COWORKING_SPACE', 'RESTAURANT_SPACE'] as const
...
export const createPropertySchema = z.object({
  ...
  propertyCategory: propertyCategorySchema.optional().default('RESIDENTIAL'),
