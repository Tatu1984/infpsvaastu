...
async function main() {
  ...
  const admin = await prisma.user.upsert({
    where: { email: 'admin@infpsvaastu.com' },
    update: {},
    create: {
      email: 'admin@infpsvaastu.com',
  ...
  const admin2 = await prisma.user.upsert({
    where: { email: 'superadmin@infpsvaastu.com' },
    update: {},
    create: {
      email: 'superadmin@infpsvaastu.com',
      password: adminPassword,
  ...
  console.log('Created backup admin user:', admin2.email)
